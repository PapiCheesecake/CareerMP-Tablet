...
CareerMP Tablet is a UI overlay for the CareerMP mod in BeamNG.drive. It provides a unified tablet experience for viewing your career dashboard, selecting jobs, tracking missions, managing vehicles, and handling recovery operations.
...
Contributions are welcome! If you want to add new tablet features, improve the UI, or fix issues:
...
This project is licensed under the terms in `LICENSE`. Refer to that file for the full license details.
